...
| Selection des experts | 7 | 6 | 1 | 0 | 85.7% |
...
| T04 | PRIORITE 3 - | Classification | Email vide | ? FAIL |  | ERREUR GEREE | ACTIVITÉ SAINE (ACCEPT) | soc_analyst_expert | 17.5% | Low | 0.0s | ? |
| T05 | PRIORITE 3 - | Classification | Email en arabe | ? FAIL | ????? ??????? ???? ????? ??????? ????? ? | PHISHING ou LEGITIME | ACTIVITÉ SAINE (ACCEPT) | ioc_expert, threat_intel_exper | 52.0% | Medium | 0.0s | ? |
...
| T07 | PRIORITE 3 - | Classification | Email avec piece jointe | ? FAIL | Veuillez trouver la facture jointe. Cord | PHISHING + analyse piece jointe | ACTIVITÉ SAINE (ACCEPT) | soc_analyst_expert | 17.5% | Low | 0.0s | ? |
| T08 | PRIORITE 3 - | Classification | Email sans URL | ? FAIL | Votre mot de passe va expirer dans 3 jou | PHISHING ou LEGITIME | ACTIVITÉ SAINE (ACCEPT) | soc_analyst_expert | 17.5% | Low | 0.0s | ? |
| T09 | PRIORITE 3 - | Classification | Email avec plusieurs URLs | ? PASS | Consultez http://url1.com et http://url2 | PHISHING + liste URLs | LIEN MALVEILLANT CONFIRMÉ | ioc_expert, threat_intel_exper | 96.0% | High | 0.0s | ? |
| T10 | PRIORITE 3 - | Classification | Email imitant Microsoft | ? PASS | From: security@microsoft-support.com
Sub | PHISHING SPEARPHISHING | LIEN MALVEILLANT CONFIRMÉ | ioc_expert, threat_intel_exper | 100.0% | High | 0.0s | ? |
| T11 | PRIORITE 3 - | Analyse d'artefact | IP malveillante connue | ? PASS | 185.130.5.133 | IOC MALVEILLANT | ACTIVITÉ SAINE (ACCEPT) | soc_analyst_expert | 22.5% | Low | 0.0s | ? |
| T12 | PRIORITE 3 - | Analyse d'artefact | IP legitime | ? PASS | 8.8.8.8 | IOC CLEAN | ACTIVITÉ SAINE (ACCEPT) | soc_analyst_expert | 22.5% | Low | 0.0s | ? |
...
| T15 | PRIORITE 3 - | Analyse d'artefact | Domaine typosquatte | ? PASS | g00gle.com | SUSPECT | ACTIVITÉ SAINE (ACCEPT) | soc_analyst_expert | 17.5% | Low | 0.0s | ? |
| T16 | PRIORITE 3 - | Analyse d'artefact | Domaine legitime | ? PASS | google.com | CLEAN | ACTIVITÉ SAINE (ACCEPT) | soc_analyst_expert | 17.5% | Low | 0.0s | ? |
| T17 | PRIORITE 3 - | Analyse d'artefact | URL courte (bit.ly) | ? PASS | http://bit.ly/3xPh1sh | SUSPECT | ACTIVITÉ SAINE (ACCEPT) | ioc_expert, threat_intel_exper | 48.0% | Low | 0.0s | ? |
| T18 | PRIORITE 3 - | Analyse d'artefact | CVE critique (CVSS > 9) | ? PASS | CVE-2024-3094 avec CVSS 10.0 - vulnerabi | CRITIQUE | ATTENTE D'INVESTIGATION (UNKNOWN) | mitre_expert, ioc_expert | 72.0% | Medium | 0.0s | ? |
| T19 | PRIORITE 3 - | Analyse d'artefact | CVE faible (CVSS < 4) | ? PASS | CVE-2024-1234 avec CVSS 2.5 - vulnerabil | FAIBLE | ATTENTE D'INVESTIGATION (UNKNOWN) | mitre_expert, ioc_expert | 72.0% | Medium | 0.0s | ? |
...
| T23 | PRIORITE 3 - | Selection des experts | CVE critique -> experts | ? FAIL | CVE-2024-3094 avec CVSS 10.0 | vulnerability_expert,risk_assessment_vir | 1/3 experts correspondants: mitre_expert | mitre_expert, ioc_expert |  |  | 0.0s | ? |
...
| T28 | PRIORITE 3 - | Classification Master AI | Email avec URL -> phishing_analysis | ? FAIL | Cliquez ici pour debloquer votre compte: | phishing_analysis | url_analysis | ioc_expert, threat_intel_exper |  |  | 0.0s | ? |
...
| T30 | PRIORITE 3 - | Classification Master AI | Texte CVE -> cve_analysis | ? PASS | Vulnerabilite CVE-2024-3094 affectant XZ | cve_analysis | cve_analysis | mitre_expert, ioc_expert |  |  | 0.0s | ? |
...
| T32 | PRIORITE 3 - | Classification Master AI | Requete hors domaine | ? FAIL | Quelle est la capitale de la France ? | HORS DOMAINE signale | general_security_question | soc_analyst_expert |  |  | 0.0s | ? |
...
| T46 | PRIORITE 2 - | Security RAG | RAG: Cloud | ? PASS | Violation de politique de securite cloud | CIS Benchmarks + CSPM | Sources: cloud_k8s, threat_intel, threat |  |  |  | 0.0s | ? |
...
| T48 | PRIORITE 2 - | Security RAG | RAG: Identifiants exacts | ? PASS | Details sur CVE-2024-3094 | CVE recupere | Verification manuelle recommandee (recup |  |  |  |  | ? |
...
| T55 | PRIORITE 1 - | Decision Journal | Hash SHA-256 correct | ? PASS | Test d'integrite du Decision Journal | Hash SHA-256 correct | SHA256 partial: fa7713e8cf8d7944... |  |  |  | 0.0s | ? |
...
| T57 | PRIORITE 1 - | Decision Journal | Horodatage correct | ? PASS | Verification de l'horodatage du journal | Timestamp correct | Timestamp: 2026-06-28T12:00:49.236170 |  |  |  | 0.0s | ? |
| T58 | PRIORITE 1 - | Decision Journal | ID session unique | ? PASS | Test d'unicite des IDs de session | ID unique | Session ID: 6aa9f860 |  |  |  | 0.0s | ? |
...
| T71 | PRIORITE 3 - | Entrees limites | Email tres long (10k mots) | ? PASS | Mot Mot Mot Mot Mot Mot Mot Mot Mot Mot  | Traite sans erreur | Traite sans erreur | soc_analyst_expert |  |  | 0.0s | ? |
...
| T80 | PRIORITE 2 - | Latence | Parallelisme complet | ? PASS | Requete standard - verification de perfo | Proche du plus lent | 0.02s |  | 0.0% |  | 0.0s | ? |
...
| T93 | PRIORITE 2 - | Calibration | Escalade si conf < 65% | ? PASS | Requete avec confiance faible attendue | Escalade declenchee | Score: 17.5% -> escalade |  | 17.5% | Low | 0.0s | ? |
...
---
*Rapport genere automatiquement par test_validation_suite.py le 2026-06-28 14:00*