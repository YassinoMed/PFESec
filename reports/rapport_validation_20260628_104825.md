...
| Selection des experts | 2 | 0 | 2 | 0 | 0.0% |
...
| T21 | PRIORITE 1 - | Selection des experts | Email phishing -> experts | ? FAIL | URGENT: Votre compte a ete suspendu. Cli | Email Expert + IOC + ThreatIntel | 0/3 experts correspondants:  | phishing_expert, email_header_ |  |  | 0.0s | ? |
| T22 | PRIORITE 1 - | Selection des experts | IOC hash -> experts | ? FAIL | e99a18c428cb38d5f260853678922e03 | Malware + IOC + ThreatIntel | 0/3 experts correspondants:  | phishing_expert, malware_exper |  |  | 0.0s | ? |
| T33 | PRIORITE 1 - | Consensus Engine | Tous les experts d'accord | ? FAIL | Phishing evident: email avec demande de  | Consensus 1er tour | Score: 82.0%, Debat: completed |  | 82.0% | High | 0.0s | ? |
...
| T55 | PRIORITE 1 - | Decision Journal | Hash SHA-256 correct | ? PASS | Test d'integrite du Decision Journal | Hash SHA-256 correct | SHA256 partial: 45b6d9c646364f2b... |  |  |  | 0.0s | ? |
...
| T57 | PRIORITE 1 - | Decision Journal | Horodatage correct | ? PASS | Verification de l'horodatage du journal | Timestamp correct | Timestamp: 2026-06-28T08:48:25.850107 |  |  |  | 0.0s | ? |
| T58 | PRIORITE 1 - | Decision Journal | ID session unique | ? PASS | Test d'unicite des IDs de session | ID unique | Session ID: bda2ff15 |  |  |  | 0.0s | ? |
...
| T69 | PRIORITE 1 - | Robustesse adversarial | Typosquatting subtil | ? PASS | Securisez votre compte: http://rnicrosof | Detecte | ATTENTE D'INVESTIGATION (UNKNOWN) | url_expert, phishing_expert, i | 67.0% | Medium | 0.0s | ? |
...
---
*Rapport genere automatiquement par test_validation_suite.py le 2026-06-28 10:48*