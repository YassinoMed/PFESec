...
| T55 | PRIORITE 1 - | Decision Journal | Hash SHA-256 correct | ? PASS | Test d'integrite du Decision Journal | Hash SHA-256 correct | SHA256 partial: d6fa0bb000138c23... |  |  |  | 0.0s | ? |
...
| T57 | PRIORITE 1 - | Decision Journal | Horodatage correct | ? PASS | Verification de l'horodatage du journal | Timestamp correct | Timestamp: 2026-06-28T08:53:46.927263 |  |  |  | 0.0s | ? |
| T58 | PRIORITE 1 - | Decision Journal | ID session unique | ? PASS | Test d'unicite des IDs de session | ID unique | Session ID: 216df813 |  |  |  | 0.0s | ? |
...
| T64 | PRIORITE 1 - | Robustesse adversarial | Phishing modifie pour tromper | ? PASS | Cher client, veuillez mettre a jour votr | Detecte par les autres | MENACE CONFIRMÉE (BLOCK) | phishing_expert, malware_exper | 53.5% | Medium | 0.1s | ? |
...
| T78 | PRIORITE 2 - | Latence | Avec 1 tour de debat | ? PASS | Requete ambigue necessitant debat entre  | < 8 secondes | 0.02s (cible: <8.0s) |  | 0.0% |  | 0.0s | ? |
...
---
*Rapport genere automatiquement par test_validation_suite.py le 2026-06-28 10:53*