...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| T01 | PRIORITE 1 - | Classification | Email phishing evident | ? PASS | URGENT: Votre compte a ete suspendu. Cli | PHISHING CONFIRME | PHISHING CONFIRMÉ | phishing_expert, email_header_ | 92.0% | High | 0.0s | ? |
| T02 | PRIORITE 1 - | Classification | Email legitime | ? PASS | Bonjour, suite a notre reunion de vendre | LEGITIME | EMAIL LÉGITIME | phishing_expert, email_header_ | 47.5% | Low | 0.0s | ? |
| T03 | PRIORITE 1 - | Classification | Email ambigu | ? PASS | Cher client, nous avons remarque une act | INCERTAIN + escalade | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T04 | PRIORITE 3 - | Classification | Email vide | ? FAIL |  | ERREUR GEREE | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T05 | PRIORITE 3 - | Classification | Email en arabe | ? PASS | ????? ??????? ???? ????? ??????? ????? ? | PHISHING ou LEGITIME | LIEN MALVEILLANT CONFIRMÉ | url_expert, phishing_expert, e | 67.0% | Medium | 0.0s | ? |
| T06 | PRIORITE 3 - | Classification | Email en anglais | ? PASS | Dear user, your account requires verific | PHISHING ou LEGITIME | PHISHING CONFIRMÉ | phishing_expert, email_header_ | 82.0% | High | 0.0s | ? |
| T07 | PRIORITE 3 - | Classification | Email avec piece jointe | ? FAIL | Veuillez trouver la facture jointe. Cord | PHISHING + analyse piece jointe | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.1s | ? |
| T08 | PRIORITE 3 - | Classification | Email sans URL | ? PASS | Votre mot de passe va expirer dans 3 jou | PHISHING ou LEGITIME | MENACE CONFIRMÉE (BLOCK) | phishing_expert, malware_exper | 62.5% | Medium | 0.0s | ? |
...
| T11 | PRIORITE 3 - | Analyse d'artefact | IP malveillante connue | ? PASS | 185.130.5.133 | IOC MALVEILLANT | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 52.0% | Medium | 0.0s | ? |
| T12 | PRIORITE 3 - | Analyse d'artefact | IP legitime | ? PASS | 8.8.8.8 | IOC CLEAN | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 52.0% | Medium | 0.0s | ? |
| T13 | PRIORITE 3 - | Analyse d'artefact | Hash malware connu | ? PASS | e99a18c428cb38d5f260853678922e03 | MALWARE CONFIRME | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T14 | PRIORITE 3 - | Analyse d'artefact | Hash inconnu | ? PASS | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | INCONNU + analyse | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T15 | PRIORITE 3 - | Analyse d'artefact | Domaine typosquatte | ? PASS | g00gle.com | SUSPECT | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T16 | PRIORITE 3 - | Analyse d'artefact | Domaine legitime | ? PASS | google.com | CLEAN | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T17 | PRIORITE 3 - | Analyse d'artefact | URL courte (bit.ly) | ? PASS | http://bit.ly/3xPh1sh | SUSPECT | ATTENTE D'INVESTIGATION (UNKNOWN) | url_expert, phishing_expert, e | 82.0% | High | 0.0s | ? |
...
| T20 | PRIORITE 3 - | Analyse d'artefact | Alerte SIEM brute | ? PASS | ALERTE: connexion SSH depuis IP 185.130. | ANALYSE SOC | ATTENTE D'INVESTIGATION (UNKNOWN) | phishing_expert, malware_exper | 60.0% | Medium | 0.0s | ? |
...
| T24 | PRIORITE 3 - | Selection des experts | Alerte SIEM -> experts | ? FAIL | ALERTE: connexion SSH brute force depuis | soc_analyst_expert,sigma_expert,mitre_ex | 1/3 experts correspondants: mitre_expert | phishing_expert, malware_exper |  |  | 0.0s | ? |
...
| T28 | PRIORITE 3 - | Classification Master AI | Email avec URL -> phishing_analysis | ? FAIL | Cliquez ici pour debloquer votre compte: | phishing_analysis | url_analysis | url_expert, phishing_expert, e |  |  | 0.0s | ? |
...
| T46 | PRIORITE 2 - | Security RAG | RAG: Cloud | ? PASS | Violation de politique de securite cloud | CIS Benchmarks + CSPM | Sources: mitre_attck, mitre_attck, threa |  |  |  | 0.0s | ? |
...
| T55 | PRIORITE 1 - | Decision Journal | Hash SHA-256 correct | ? PASS | Test d'integrite du Decision Journal | Hash SHA-256 correct | SHA256 partial: 464f4fedbf679699... |  |  |  | 0.0s | ? |
...
| T57 | PRIORITE 1 - | Decision Journal | Horodatage correct | ? PASS | Verification de l'horodatage du journal | Timestamp correct | Timestamp: 2026-06-28T11:52:44.140696 |  |  |  | 0.0s | ? |
| T58 | PRIORITE 1 - | Decision Journal | ID session unique | ? PASS | Test d'unicite des IDs de session | ID unique | Session ID: 42cd6f15 |  |  |  | 0.0s | ? |
...
| T64 | PRIORITE 1 - | Robustesse adversarial | Phishing modifie pour tromper | ? PASS | Cher client, veuillez mettre a jour votr | Detecte par les autres | MENACE CONFIRMÉE (BLOCK) | phishing_expert, malware_exper | 57.0% | Medium | 0.0s | ? |
| T65 | PRIORITE 1 - | Robustesse adversarial | Obfuscation URL | ? PASS | Cliquez sur http://google.com@evil.com/r | Detecte | LIEN MALVEILLANT CONFIRMÉ | url_expert, phishing_expert, e | 92.0% | High | 0.0s | ? |
| T66 | PRIORITE 1 - | Robustesse adversarial | Encodage base64 | ? PASS | Vm90cmUgY29tcHRlIGEgw6l0w6kgc3VzcGVuZHUg | Detecte | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T67 | PRIORITE 1 - | Robustesse adversarial | Phishing sans mots-cles | ? PASS | Bonjour, merci de bien vouloir prendre c | Detecte via structure | ACTIVITÉ SAINE (ACCEPT) | phishing_expert, malware_exper | 35.5% | Low | 0.0s | ? |
| T68 | PRIORITE 1 - | Robustesse adversarial | Texte blanc invisible | ? PASS | Cher client<span style='color:white'>phi | Detecte | EMAIL LÉGITIME | phishing_expert, email_header_ | 47.5% | Low | 0.0s | ? |
| T69 | PRIORITE 1 - | Robustesse adversarial | Typosquatting subtil | ? PASS | Securisez votre compte: http://rnicrosof | Detecte | ATTENTE D'INVESTIGATION (UNKNOWN) | url_expert, phishing_expert, e | 67.0% | Medium | 0.0s | ? |
| T70 | PRIORITE 1 - | Robustesse adversarial | Lien raccourci masquant | ? PASS | Cliquez: http://short.url/abc123 (rediri | Signale comme suspect | PHISHING CONFIRMÉ | phishing_expert, email_header_ | 87.0% | High | 0.0s | ? |
...
| T82 | PRIORITE 3 - | Charge | 50 requetes simultanees | ? PASS | Test de charge: 50 requetes en parallele | File d'attente geree | 50/50 OK en 0.7s (non bloquant) |  |  |  | 0.7s | ? |
