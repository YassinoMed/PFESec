...
export const mockGpu: GpuStatus = {
  ...
  loaded_models: ["cysecbert", "secbert", "phishsense", "securityllm"],
  cuda_version: "12.1",
};
...
export function mockPredictAll(prompt: string): PredictAllResponse {
  ...
  return {
    ...
    consensus: {
      ...
      block_votes: suspicious ? 4 : 0,
      accept_votes: suspicious ? 1 : 5,
      total_votes: 5,
      confidence_pct: suspicious ? 80 : 100,
    },
